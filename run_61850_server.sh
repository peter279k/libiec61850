...
if [[ $mode == "tls" ]]; then
    docker run -d --name="$mode-iec61850-server" --restart=always -v $PWD/config_file:/home/iec61850/config --network host -v $PWD/databases:/home/iec61850/databases -p "$port_number:8102" libiec61850:$tag_name -c "cd ./tls_server_example && ./tls_server_example 8102"
fi;
